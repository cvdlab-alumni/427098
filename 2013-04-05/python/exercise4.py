...
vetrata1 = COLOR(BLACK)(traslate([2,3],[vetrata_trasl_y,vetrata_trasl_z] ,CUBOID([south_face_x,vetrata_y,vetrata_z])))

vetrata2 = COLOR(BLACK)(traslate([3],[2.45] ,vetrata1))
