...
vetrata_y = 4.944
vetrata_z = 2.019
vetrata_trasl_y = 0.237
vetrata_trasl_z = 0.3

vetrata1 = COLOR([0,0,0])(traslate([2,3],[vetrata_trasl_y,vetrata_trasl_z] ,CUBOID([south_face_x,vetrata_y,vetrata_z])))

vetrata2 = COLOR([0,0,0])(traslate([3],[2.45] ,vetrata1))

vetrate = STRUCT([vetrata1,vetrata2 ])


south = traslate([3],[south_face_z],STRUCT([south_face_r1,south_face_r2,south_face_r3,south_face_r4,south_face_r5,south_face_r6,vetrate]))
